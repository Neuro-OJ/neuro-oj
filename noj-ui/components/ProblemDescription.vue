...
<template>
  <div class="md-render" v-html="rendered" />
</template>
...
/* Headings */
.md-render h1 { font-size: 1.6em; font-weight: 700; margin: 1.2em 0 0.6em; }
.md-render h2 { font-size: 1.35em; font-weight: 700; margin: 1.1em 0 0.5em; }
.md-render h3 { font-size: 1.15em; font-weight: 600; margin: 1em 0 0.4em; }
...
/* Lists */
.md-render ul,
.md-render ol { padding-left: 1.6em; margin: 0.5em 0; }
.md-render li { margin: 0.25em 0; }
.md-render li > ul,
.md-render li > ol { margin: 0.2em 0; }

/* Inline code */
.md-render code:not(.hljs code) {
  background: #f1f5f9;
  padding: 2px 6px;
  border-radius: 4px;
