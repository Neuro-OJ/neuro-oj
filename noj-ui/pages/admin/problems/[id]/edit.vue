...
async function loadData() {
  ...
  try {
    ...
    judgeImage.value = p.judge_image
    judgeCommand.value = p.judge_command
    timeLimitMs.value = p.time_limit_ms
    memoryLimitMb.value = p.memory_limit_mb
