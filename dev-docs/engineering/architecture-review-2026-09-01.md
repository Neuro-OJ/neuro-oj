> ⚠️ **本文为 2026-09-01 的时点快照，部分结论已被后续代码推翻。**
> 最新评审见 [`architecture-review-2026-09-12.md`](architecture-review-2026-09-12.md)：
> 本文 §4.2「无前端单元测试 / composable 命名混用」已不成立（现已有前端测试并接入 CI，
> 31 个 composable 全部 camelCase）。**引用本文前请先核对最新评审。**
>
> 约定：评审类文档是**时点快照**，不回溯修改结论；如被推翻，在顶部加修订指针
> （见 `dev-docs/engineering/README.md`）。
