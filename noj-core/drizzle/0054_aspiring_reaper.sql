...
UPDATE "community_reports" SET "content_type" = 'comment' WHERE "comment_id" IS NOT NULL AND "post_id" IS NULL;--> statement-breakpoint
...
ALTER TABLE "community_reports" ADD CONSTRAINT "community_reports_sanction_id_community_sanctions_id_fk" FOREIGN KEY ("sanction_id") REFERENCES "community_sanctions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "community_reports" ADD CONSTRAINT "community_reports_ban_id_user_bans_id_fk" FOREIGN KEY ("ban_id") REFERENCES "user_bans"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
