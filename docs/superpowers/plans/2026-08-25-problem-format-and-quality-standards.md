...
**Spec:** `docs/superpowers/specs/2026-08-25-problem-format-and-quality-standards-design.md`
...
**Interfaces:**
- Consumes: 设计文档 `docs/superpowers/specs/2026-08-25-problem-format-and-quality-standards-design.md`
...
将设计文档 `docs/superpowers/specs/2026-08-25-problem-format-and-quality-standards-design.md` 的内容复制到该文件（保留全部章节）。
