...
- 设计文档：`docs/superpowers/specs/2026-08-12-avatar-profile-design.md`（本计划唯一事实来源，冲突时以设计文档为准）。
...
**Interfaces:**
- Consumes: 设计文档 `docs/superpowers/specs/2026-08-12-avatar-profile-design.md`
