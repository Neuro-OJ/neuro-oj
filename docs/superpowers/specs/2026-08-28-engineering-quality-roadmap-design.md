...
| 0.5 工程文档 | 新增 `docs/engineering/testing.md`、`docs/engineering/defensive-patterns.md`、`docs/engineering/development.md` | 与现状一致并链接到 AGENTS |
...
- 月度质量审计：复用 8 月审计方法，扫描 docs/comment/coverage。
...
- `docs/audit/2026-08-15-noj-audit/docs.md`：文档漂移清单
