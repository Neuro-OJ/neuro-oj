...
JUDGE_PREDICTION_WORKSPACE_MB=2048
...
services:
  judge:
    ...
    environment:
      ...
      JUDGE_PRIORITY_POLL_TIMEOUT_MS: "${JUDGE_PRIORITY_POLL_TIMEOUT_MS:-100}"
      ...
      JUDGE_PREDICTION_WORKSPACE_MB: "${JUDGE_PREDICTION_WORKSPACE_MB:-2048}"
